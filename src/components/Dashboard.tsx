...
import { CheckCircle2, IdCard, AlertTriangle, Network, MapPin, ChevronRight, ShieldCheck, Zap, Building2, Cctv, DoorOpen, Navigation, Hospital, ShoppingCart, Shield } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        <Card className={cn(
          ...
          <div className="flex justify-between items-start relative z-10">
            ...
            <ShieldCheck className="w-8 h-8 md:w-10 md:h-10 text-primary-foreground/80" />
          </div>
